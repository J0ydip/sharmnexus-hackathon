  ...
  return (
    ...
    <main>
        <section className="hero" id="home">
            ...
            <div className="hero-product" aria-label="SharmNexus service matching preview">
                <div className="product-glow"></div>
                <div className="product-window">
                    <div className="window-top"><span className="window-dots"><i></i><i></i><i></i></span><span className="window-title">SharmNexus / Find a professional</span><span>•••</span></div>
        ...
        <section className="accessibility section-pad" id="accessibility">
            ...
            <a className="button button-dark" href="/auth/login"><span data-i18n="access_explore">Explore SharmNexus</span> <span>↗</span></a>
        </section>
        ...
        <section className="testimonials section-pad"><div className="section-kicker">REAL PEOPLE. REAL IMPACT.</div><div className="section-heading-row"><h2>Trust is something<br /><em>we build together.</em></h2><div className="testimonial-count">01 <span>/</span> 04</div></div><div className="testimonial-grid">
            ...
            <article className="tilt-2"><div className="stars">★★★★★</div><blockquote>“As a worker, SharmNexus has given me consistent job opportunities and a fairer way to build my reputation.”</blockquote><strong>Manoj Kumar</strong><small>Verified Electrician · Delhi</small></article>
