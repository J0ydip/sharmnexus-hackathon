...
function ServicesContent() {
  ...
  return (
    <div className="min-h-screen bg-gray-50/60 pb-20 sm:pb-12">
      {/* Header Banner */}
      <div className="bg-gradient-to-r from-emerald-900 via-emerald-800 to-teal-900 text-white pt-8 pb-12 px-4 sm:px-6 shadow-xs">
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <div className="inline-flex items-center gap-1.5 bg-emerald-700/50 text-emerald-200 text-xs font-semibold px-3 py-1 rounded-full border border-emerald-600/50 mb-2">
          ...
          <div className="mt-6 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-white text-gray-900 placeholder-gray-400 text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-emerald-400 shadow-xs"
              />
            </div>
          ...
          <div className="bg-white rounded-2xl p-5 border border-gray-200 shadow-xs space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">
                  Showing verified workers in Patna District Labour Society & nearby clusters
                </p>
              </div>
              <span className="text-xs font-semibold text-emerald-700 bg-emerald-50 px-2.5 py-1 rounded-full border border-emerald-200">
                {workers.length} Active Verified Craftsmen
              </span>
            </div>
            ...
            <div className="h-[450px] w-full rounded-xl overflow-hidden">
              <MapView
                ...
                addressName="Your Area (Kankarbagh, Patna)"
              />
            </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                {workers.slice(0, 6).map((worker) => (
                  <div
                    ...
                    className="p-3 rounded-xl bg-gray-50 hover:bg-emerald-50/50 border border-gray-200/80 cursor-pointer transition-colors flex items-center justify-between"
                  >
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        ...
                        <span className="text-[11px] text-emerald-700 font-semibold">{worker.primary_skill}</span>
                      </div>
                    </div>
