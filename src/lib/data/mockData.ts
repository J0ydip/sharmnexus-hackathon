...
export const INITIAL_WORKERS: WorkerProfile[] = [
  {
    ...
    reviews: [
      ...
      },
      {
        ...
        rating: 4.5,
        comment: 'Great plumbing work and clean finishing. Highly recommended through ShramNexus.',
        date: '2 weeks ago',
        service_name: 'Plumbing',
      },
    ],
  },
  {
    ...
    email: 'priya.das@shramnexus.coop',
  ...
  },
  {
    ...
    email: 'amit.roy@shramnexus.coop',
  ...
  },
  {
    ...
    email: 'sanjay.shaw@shramnexus.coop',
  ...
  },
  {
    ...
    email: 'mousumi.sen@shramnexus.coop',
  ...
  },
  {
    ...
    email: 'vikram.singh@shramnexus.coop',
  ...
  },
  {
    ...
    email: 'ramesh.patel@shramnexus.coop',
  ...
  },
  {
    ...
    email: 'anita.rao@shramnexus.coop',
  ...
  },
  {
    ...
    email: 'sunita.devi@shramnexus.coop',
  ...
  // Extra Plumber for comparison
  {
    ...
    email: 'mahesh.yadav@shramnexus.coop',
...
export const INITIAL_DEMO_BOOKINGS: Booking[] = [
  {
    ...
    status: 'completed',
    urgency: 'emergency',
    description: 'Kitchen sink pipe repair under the counter.',
    address: 'Cooperative Enclave, Sector 2',
    city: 'Kolkata',
    lat: 22.5726,
    lng: 88.3639,
